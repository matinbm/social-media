...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    # def setup raftan be database ra kam mikard
    def setup(self, request, *args, **kwargs):
        self.post_instance = get_object_or_404(Post, pk=self.kwargs['post_id'])
        return super().setup(request, *args, **kwargs)

    # dispatch baaes mishe ke ye code tooye get va post tekrar nashe
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_post.save()
            messages.success(request, 'successful created', 'post created')
